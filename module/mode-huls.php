...
function insert($data){
    ...
    $sqlHuls = "INSERT INTO tbl_huls VALUES (null, '$no_huls', '$nama_bahan', '$no_bets', '$no_spesifikasi', '$no_metode_analisa', '$hasil_pengujian', '$persyaratan_hasil_uji', '$tanggal_sampling', '$tanggal_pengujian', '$nama_analis')";
